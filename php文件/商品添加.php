...
<body>
    ...
    <div class="container">
        <h1>Sign up</h1>
        <form action="商品添加.php?name=<?php echo $name ?>" method="post" name="register" onsubmit = "return check()">
        ...
        <p class="change_link" style="text-align: center">
            ...
            <a href="./商品管理员功能界面.php?name=<?php echo $name ?>" class="to_login"> Back </a>
	    </p>
        </form>
    </div>
    <ul>
