...
<body>
    <div class="d1">
        ...
        <table class="table">  
            ...
            $sql = "select * from store where store_id != 0 order by store_id asc";
            ...
            $sql = "select * from store where store_id != 0 order by store_id asc limit $start,10";
            $result = mysqli_query($conn,$sql);
            $length = mysqli_num_rows($result);
            if($length>0){
                for($i=0;$i<$length;$i++){
